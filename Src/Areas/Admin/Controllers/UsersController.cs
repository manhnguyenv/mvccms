    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult Create(User user, HttpPostedFileBase image_avatar, bool status_mi)
        {
            if (ModelState.IsValid)
            {
                ...
                if (checkemail > 0)
                {
                    ViewBag.erroremail = "Email Đăng Ký Đã Tồn Tại";
                }
                else
                {
        ...
        public ActionResult postChangePassword(string pass_old, string pass_new, string pass_new_repeat)
        {
            ...
            {
                TempData["errordisplaypass"] = "display:block!important";
            ...
            else
            {
                if (pass_new.Length >= 6 && pass_new_repeat.Length >= 6)
                {
                    if (pass_new_repeat == pass_new)
                    {
                        ...
                        db.SaveChanges();
                        TempData["displaypass"] = "display:block!important";

                        TempData["success_pass"] = "Thay đổi mật khẩu thành công";
                ...
                else
                {
                    ...
                    TempData["errorlengthpass"] = "Mật khẩu mới không được dưới 6 kí tự";
                }
            }
